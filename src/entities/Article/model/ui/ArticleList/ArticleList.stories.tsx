...
SmallLight.decorators = [ThemeDecorator(Theme.LIGHT)];

export const SmallLightIsLoading = Template.bind({});
SmallLightIsLoading.args = {
    view: ArticleView.SMALL,
    isLoading: true,
};

SmallLightIsLoading.decorators = [ThemeDecorator(Theme.LIGHT)];
...
BigLight.decorators = [ThemeDecorator(Theme.LIGHT)];

export const BigLightIsLoading = Template.bind({});
BigLightIsLoading.args = {
    view: ArticleView.BIG,
    isLoading: true,
};

BigLightIsLoading.decorators = [ThemeDecorator(Theme.LIGHT)];
